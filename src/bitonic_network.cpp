...
// #include "bitonic_network.hpp"
// #include "balancer.hpp"

// template<typename T>
// BitonicNetwork<T>::BitonicNetwork(int width){
...
//         tmp_wires.push_back(NW(curr, ref(curr->up_), true));
//         tmp_wires.push_back(NW(curr, ref(curr->down_), false));
...
// template<typename T>
// OutputNode<T>* BitonicNetwork<T>::traverse(int id){
